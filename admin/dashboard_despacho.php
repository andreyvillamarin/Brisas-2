...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'complete') {
    ...
    // Redirigir para evitar reenv¨ªo del formulario y asegurar que la tabla se vea actualizada
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle">
                    ...
                    <tbody id="orders-table-body">
                        <!-- El contenido se cargar¨¢ aqu¨ª v¨ªa AJAX -->
                    </tbody>
                </table>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addEventListenersToButtons() {
        document.querySelectorAll('.view-details-btn-despacho').forEach(button => {
            button.addEventListener('click', async () => {
                ...
                // ... (toda la l¨®gica para construir el HTML del modal sigue aqu¨ª)
    ...
    // Exponer la funci¨®n de carga para que pueda ser llamada desde el footer
